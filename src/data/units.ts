  ...
  highlights: [
    {
      ...
      desc: "Manhã generosa com cesta de pães, frutas frescas, ovos e cafés filtrados.",
    },
    {
      title: "Confeitaria autoral",
      desc: "Bolos da vovó, croissants recheados e o famoso Brownie Bowl.",
    },
    {
      title: "After Coffee",
      desc: "Nas sextas e sábados, a casa muda de tom: luz baixa, taças e pratos de compartilhar.",
    },
  ],
  menu: [
    {
      name: "Trio de Bolos",
      desc: "Três bolos do dia, fatias generosas para compartilhar.",
      price: "R$ 70",
      image: cakesImg,
    ...
    {
      name: "Brownie Bowl",
      desc: "Brownie quente, sorvete, morangos, nutella e calda.",
      price: "R$ 41",
      image: cakesImg,
      category: "confeitaria",
    },
    {
      name: "Bolo Pudim",
      desc: "Duas paixões em uma só fatia, untuoso e aveludado.",
      price: "R$ 28",
      image: cakesImg,
      category: "confeitaria",
    },
    {
      ...
      desc: "Recheado com brigadeiro de pistache.",
      price: "R$ 49",
      image: cakesImg,
      category: "confeitaria",
    },
    ...
    },
    {
      ...
      desc: "Folhado artesanal, gema corrida e ervas frescas.",
      price: "R$ 38",
      image: empanadaImg,
      category: "bistro",
    },
    {
      name: "Quiche de Brie & Damasco",
      desc: "O contraste perfeito entre o doce e o salgado.",
      price: "R$ 36",
      image: empanadaImg,
      category: "bistro",
    },
    {
      ...
      desc: "Queijo gruyère, presunto royale e bechamel da casa, gratinado.",
      price: "R$ 42",
      image: empanadaImg,
      category: "bistro",
    },
    {
      ...
      desc: "Espresso, leite vaporizado e marshmallow tostado.",
      price: "R$ 33",
      image: coffeeImg,
      category: "cafeteria",
    },
    {
      name: "Hario V60",
      desc: "Coado especial 200ml, perfil floral e adocicado.",
      price: "R$ 20",
      image: coffeeImg,
      category: "cafeteria",
    },
    ...
    {
      name: "Aperol Spritz",
      desc: "Aperol, água com gás, champagne e toque de laranja.",
      price: "R$ 38",
      image: coffeeImg,
      category: "cafeteria",
    },
  ...
  weekly: [
    ...
    [
      ...
      },
      {
        tag: "Café do dia",
        name: "Hario V60",
        desc: "Coado especial 200ml, floral e adocicado.",
        price: "R$ 20",
        image: coffeeImg,
      },
      {
    ...
    [
      {
        tag: "Sexta-feira pede",
        name: "Aperol Spritz",
        desc: "Aperol, água com gás, champagne e laranja.",
        price: "R$ 38",
        image: coffeeImg,
      },
      {
      ...
      },
      {
        tag: "After Coffee",
        name: "Croissant Gruyère",
        desc: "Gruyère, presunto royale e bechamel, gratinado.",
        price: "R$ 42",
        image: empanadaImg,
      },
    ],
...
const praiaDaCosta: Unit = {
  ...
  wineMenuLabel: "Carta de drinks e vinhos",
  about:
  ...
  highlights: [
    {
      title: "Grab & Go",
      desc: "Cafés especiais, croissants e doces para levar a caminho da praia.",
    },
    {
      title: "Sanduíches autorais",
      desc: "Toasts de fermentação natural com recheios criados pela chef Samira.",
    },
    {
      title: "Encomendas locais",
      desc: "Bolos inteiros, naked cakes e cestas de café da manhã com retirada no bairro.",
    },
  ],
  menu: [
    {
    ...
    },
    {
      ...
      desc: "Massa fofa, glacê delicado e geleia artesanal.",
      price: "R$ 18",
      image: cakesImg,
      category: "confeitaria",
    },
    {
      ...
      desc: "Crocante por fora, com recheio cremoso de doce de leite.",
      price: "R$ 14",
      image: cakesImg,
      category: "confeitaria",
    },
    {
      ...
      desc: "Pão de fermentação natural, abacate amanteigado e ovo poché.",
      price: "R$ 34",
      image: empanadaImg,
      category: "bistro",
    },
    {
      ...
      desc: "Pão rústico, brie, damasco e rúcula.",
      price: "R$ 32",
      image: empanadaImg,
      category: "bistro",
    },
    {
      ...
      desc: "Massa dourada com recheios autorais que mudam diariamente.",
      price: "R$ 24",
      image: empanadaImg,
      category: "bistro",
    },
    {
      name: "Espresso Duplo",
      desc: "Grãos especiais, encorpado, para o ritmo da orla.",
      price: "R$ 12",
      image: coffeeImg,
      category: "cafeteria",
    },
    {
      ...
      desc: "Clássico gelado, cremoso, com nota de cacau.",
      price: "R$ 29",
      image: coffeeImg,
      category: "cafeteria",
    },
    {
      name: "Café Bom Bom",
      desc: "Espresso encorpado sobre camada generosa de leite condensado.",
      price: "R$ 18",
      image: coffeeImg,
      category: "cafeteria",
    },
    {
      name: "Limonada Suíça",
      desc: "Refrescante, perfeita pós praia.",
      price: "R$ 16",
      image: coffeeImg,
      category: "cafeteria",
    },
    ...
    [
      {
        tag: "Domingo na orla",
        name: "Toast Praia da Costa",
        desc: "Abacate amanteigado e ovo poché em pão de fermentação.",
        price: "R$ 34",
        image: empanadaImg,
      },
      {
      ...
      },
      {
        tag: "Café do dia",
        name: "Café Bom Bom",
        desc: "Espresso e leite condensado.",
        price: "R$ 18",
        image: coffeeImg,
      },
    ],
    [
      {
        tag: "Grab & Go",
        name: "Espresso Duplo",
        desc: "Para começar a semana com energia.",
        price: "R$ 12",
        image: coffeeImg,
      },
      {
        tag: "Doce do dia",
        name: "Cookie Recheado",
        desc: "Doce de leite cremoso por dentro.",
        price: "R$ 14",
        image: cakesImg,
      },
      {
        tag: "Salgado do dia",
        name: "Empanada do dia",
        desc: "Recheios autorais que mudam diariamente.",
        price: "R$ 24",
        image: empanadaImg,
      },
    ],
    [
      {
        ...
        name: "Sanduíche Mediterrâneo",
        desc: "Brie, damasco e rúcula em pão rústico.",
        price: "R$ 32",
        image: empanadaImg,
      },
      {
        tag: "Refrescante",
        name: "Limonada Suíça",
        desc: "Geladinha, perfeita pós praia.",
        price: "R$ 16",
        image: coffeeImg,
      },
      {
        tag: "Doce do dia",
        name: "Donuts de Frutas Vermelhas",
        desc: "Glacê delicado e geleia artesanal.",
        price: "R$ 18",
        image: cakesImg,
      },
    ],
    [
      {
        tag: "Brunch leve",
        name: "Toast Praia da Costa",
        desc: "Para um almoço rápido na orla.",
        price: "R$ 34",
        image: empanadaImg,
      },
      {
      ...
      },
      {
        tag: "Doce do dia",
        name: "Cookie Recheado",
        desc: "Crocante por fora, cremoso por dentro.",
        price: "R$ 14",
        image: cakesImg,
      },
    ],
    ...
    [
      {
        tag: "Sexta na orla",
        name: "Empanada do dia",
        desc: "Recheio especial de sexta.",
        price: "R$ 24",
        image: empanadaImg,
      },
      {
